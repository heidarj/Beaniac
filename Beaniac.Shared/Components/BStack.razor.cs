...
namespace Beaniac.Shared.Components;

public partial class BStack : FluentComponentBase
{
    ...
    /// </summary>
    [Parameter]
    public VerticalAlignmentValue VerticalAlignment { get; set; } = VerticalAlignmentValue.Top;
    ...
    /// <summary>
    /// Gets or sets the Height of the stack as a percentage string (default = 100%).
    /// </summary>
    [Parameter]
    ...
    private string GetVerticalAlignment()
    {
        ...
        {
            VerticalAlignmentValue.Top => "start",
            VerticalAlignmentValue.Center => "center",
            VerticalAlignmentValue.Bottom => "end",
            VerticalAlignmentValue.SpaceBetween => "space-between",
            VerticalAlignmentValue.SpaceAround => "space-around",
            VerticalAlignmentValue.SpaceEvenly => "space-evenly",
            _ => "start",
        };
    }
}
